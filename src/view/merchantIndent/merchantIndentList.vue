<template>
  <div style="padding:0 24px 24px;">
      ...
      <Card shadow style="margin-top:10px;">
        ...
        <Button type="success" style="margin-left:30px;" @click="new_indent('new')">发单</Button>
...
export default {
  ...
  data () {
    return {
      ...
      statusOptions:[
        ...
        {label:'进行中的订单',value:3},
        {label:'已完成的订单',value:4},
        {label:'未进行的订单',value:5},
      ],
      date_val:['',''],
      driverName:'',
      driverGather:[],
  ...
  methods: {
    ...
    checkDriver(index){
        this.$router.push({path:'merchantIndentDetail',query:{id:index}});
    },
    new_indent(new_type){
        this.$router.push({path:'newMerchantIndent',query:{type:new_type}});
    },
    cancel(entity_id){
