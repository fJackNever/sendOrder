<template>
  <div style="padding:0 24px 24px;">
    <topHost :itemCol="leagueDriverData" :style="{marginTop:'30px'}"></topHost>
    ...
    <Row style="margin-top:30px;" :gutter="20">
      <Col span="18">
        ...
        <topHost :itemCol="leagueIndentData" :style="{}"></topHost>
      </Col>
      <Col span="6">
  ...
  data () {
    return {
      ...
      leagueDriverData: [
        ...
        { title:'已完成订单量',colSpan:4,value:8,em:true},
        { title:'已完成订单流水',colSpan:4,value:8,em:false},
      ],
      leagueIndentData:[
        { title:'加盟司机数',colSpan:4,value:60,em:true},
        { title:'订单数',colSpan:4,value:8,em:true},
        { title:'流水',colSpan:4,value:8,em:true},
        { title:'上线司机数',colSpan:4,value:60,em:false},
      ],
      myChart: null,
      changeChartsShake:'',
      motorCadeSelected:1,
