  ...
  <div style="padding:0 24px 24px;">
            ...
            <Col span="12">
                <Form ref="formValidate" :model="formValidate" :label-width="80" >
                    ...
                    <FormItem label="发动机号" prop="engineNum">
                        <InputNumber :min="0" v-model="formValidate.engineNum"></InputNumber>
                    </FormItem>
            ...
            <Col span="12">
                ...
                <Form ref="formDriverValidate" :model="formDriverValidate" :label-width="80" >
                    ...
                    <Row>
                        <Col span="3">
                            <FormItem>
                                <Button type="error" @click="handleUnbind()">解绑</Button>
                            </FormItem>
                        </Col>
                        <Col span="3">
                            <FormItem>
    ...
    <Modal title="绑定司机" v-model="bindVisible" :footer-hide="true">
        <Form ref="formSelectValidate" :model="formSelectValidate" :rules="ruleSelectValidate" :label-width="120" >
            <FormItem label="绑定的司机" prop="bindDriver" :label-width="120">
                <AutoComplete
                    v-model="formSelectValidate.bindDriver"
                    :data="bindDriverGather"
...
export default {
  ...
  data () {
    return {
      ...
      ruleSelectValidate:{
          bindDriver:[
              { required: true, message: '请输入绑定的司机', trigger: 'blur' }
          ]
      },
      bindVisible:false,
      bindDriver:'',
