<template>
  <div style="padding:0 24px 24px;">
    ...
    <Card shadow title="绑定司机信息" class="indentCard" v-if="driver_info_show">
        <Row>
            <Col span="12">
        ...
        this.$refs[name].validate((valid) => {
            if (valid) {
                    ...
                    this.editCar({ 
                        ...
                        travel_img_path:this.driveList[0].url,
                        ...
                        car_person_img_path:this.perCarList[0].url,
            ...
            this.getCarLists({ id:this.$route.query.id,status:'',car_template_id:'',start_time:'',end_time:'',car_no:'',search:'',offset:0,limit:10000 }).then((data) => {
                if(data.data.data.rows[0].binding_info.id_name === ''){
                    ...
                    if(data.data.data.rows[0].binding_info.id_img_path){
                        this.$set(this.idFrontList,0,{ url:data.data.data.rows[0].binding_info.id_img_path, name:'driveHeadPic1' });
                    }
